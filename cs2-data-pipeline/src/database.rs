...
use qdrant_client::qdrant::{CreateCollection, PointStruct, SearchPoints, Value, Vectors};
                ...
                payload.insert(
                    ...
                    Value {
                        kind: Some(qdrant_client::qdrant::value::Kind::IntegerValue(
                            embedding.player_steamid,
                        )),
                    },
                );
                payload.insert(
                    "moment_type".to_string(),
                    Value {
                        kind: Some(qdrant_client::qdrant::value::Kind::StringValue(
                            embedding.moment_type.clone(),
                        )),
                    },
                );
                payload.insert(
