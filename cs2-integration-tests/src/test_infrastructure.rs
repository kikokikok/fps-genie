...
impl TestDataFactory {
    ...
    pub fn sample_player_snapshot() -> std::collections::HashMap<String, serde_json::Value> {
        ...
        data.insert(
            "steamid".to_string(),
            serde_json::Value::String("76561198123456789".to_string()),
        );
        data.insert(
            "tick".to_string(),
        ...
        data.insert(
            "pos_x".to_string(),
            serde_json::Value::Number(serde_json::Number::from_f64(100.5).unwrap()),
        );
        data.insert(
            "pos_y".to_string(),
            serde_json::Value::Number(serde_json::Number::from_f64(200.5).unwrap()),
        );
        data.insert(
            "pos_z".to_string(),
            serde_json::Value::Number(serde_json::Number::from_f64(64.0).unwrap()),
        );
        data.insert(
            "health".to_string(),
    ...
    pub fn sample_match_metadata() -> std::collections::HashMap<String, serde_json::Value> {
        ...
        data.insert(
            "map_name".to_string(),
            serde_json::Value::String("de_dust2".to_string()),
        );
        data.insert(
            "team_a".to_string(),
            serde_json::Value::String("Team Alpha".to_string()),
        );
        data.insert(
            "team_b".to_string(),
            serde_json::Value::String("Team Beta".to_string()),
        );
        data.insert(
            "tournament".to_string(),
            serde_json::Value::String("Test Tournament".to_string()),
        );
        data
    }
